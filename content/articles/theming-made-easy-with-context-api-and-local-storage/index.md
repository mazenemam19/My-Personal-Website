...
I get a value stored on the local storage (typically you won't have this value if this is your first time using the app) and I find the last theme the user had based on it.
